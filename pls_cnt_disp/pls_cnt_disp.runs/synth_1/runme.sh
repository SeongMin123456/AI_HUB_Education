...
HD_PWD='C:/Users/user/Desktop/Vivado_test/vivado/pls_cnt_disp/pls_cnt_disp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pls_cnt_disp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pls_cnt_disp.tcl

...
HD_PWD='C:/Users/user/Desktop/Vivado_test/vivado/Stop_watch/Stop_watch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pls_cnt_disp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pls_cnt_disp.tcl -notrace

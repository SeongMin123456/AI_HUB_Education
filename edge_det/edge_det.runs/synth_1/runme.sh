...
HD_PWD='C:/Users/user/Desktop/Vivado_test/vivado/edge_det/edge_det.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log edge_pro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source edge_pro.tcl

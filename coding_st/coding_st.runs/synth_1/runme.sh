...
HD_PWD='C:/Users/user/Desktop/Vivado_test/vivado/coding_st/coding_st.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_test.tcl
